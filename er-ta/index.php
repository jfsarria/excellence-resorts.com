...
<head>
  ...
  <script type="text/javascript" src="/er-core/js/core.js?060616-1"></script>
...
<div id="container">
	<div id="content">
		<div class="tab_menu">
            ...
            <div class="ta-tabs" style="display:none"><a id="tabTAAccount" class="active" href="#/account">travel agent account</a> | <a href="#/reservations" id="tabReservations" >reservations</a> | <a target="_blank" href="https://www.excellenceresorts.com/gallery/" id="tabImages" >images & logos</a> | <a href="#/images" id="tabVacation" >my vacation</a> | <a id="tabLogOut" href="#">log out</a></div>
        </div><!--.tab_menu-->
        ...
        <div style="padding:0px 22px 16px;color: #666;font-size: 13px;">*Flight + Hotel is not commissionable for Travel Agents</div>
        </form>
        ...
        <form style="display: none;" id="guestLoginForm">
       	<div id="login_form">
            ...
            <div style="padding: 0px 22px 16px 87px;color: #666;font-size: 13px;">*Flight + Hotel is not commissionable for Travel Agents</div>
        </form>
