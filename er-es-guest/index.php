        ...
        <form style="display: none;" id="singleReservationForm">
       	<div id="guest_single_reservation_block">
        	...
        	<div class="column no-float">
                ...
                <div class="item-group">
                    <div class="item">
                        <label>No. de Habitaciones:</label><span class="autofill" id="GUEST_ROOMS">0</span>
                    </div><!--.item-->
                    <div class="item">
                    <label>No. de Huéspedes:</label><span class="autofill" id="ROOM_COUNT">0</span>
                    </div><!--.item-->
                    <div class="item">
                    <label>Trans. Fecha:</label><span class="autofill" id="DATETRANS">July 16, 2011</span>
                    </div><!--.item-->
				        </div><!--.item-group-->
            ...
            <div class="column no-float">
                ...
                <h3>Cancelación de la Información</h3>
    	...
    	<div class="sb_block">
            <form action="/er" id="aviailability_form">
                <ul class="sb_menu">
                    ...
                    <li class="last"><a href="http://vacationsbyexcellence.poweredbygps.com/?utm_source=newsletter&utm;medium=email&utm_content=paquetes&gdp=cntv" target="_blank">Vuelo</a></li>
                </ul><!--.sb_menu-->
                <div class="form-item">
