...
if(!isset($_SERVER['HTTPS'])) {
	header('Location: https://www.excellence-resorts.com/er-ta');
	exit;
}
?>
...
<head>
  ...
  <script type="text/javascript" src="/er-core/js/core.js?new"></script>
...
<div id="container">
	<div id="content">
		<div class="tab_menu">
            ...
            <div class="anonim-tabs" style="display:none"><a id="tabGuestAccount" class="active" href="#/account">travel agent account</a></div>
            <div class="ta-tabs" style="display:none"><a id="tabTAAccount" class="active" href="#/account">travel agent account</a> | <a href="#/reservations" id="tabReservations" >reservations</a> | <a target="_blank" href="https://www.excellenceresorts.com/es/gallery/" id="tabImages" >images & logos</a> | <a href="#/images" id="tabVacation" >my vacation</a> | <a id="tabLogOut" href="#">log out</a></div>
        </div><!--.tab_menu-->
        ...
        <form id="optionalPrefs" style="display:none;" method="get" action="/ibe/index.php">
          ...
          <div id="opotional_form">        	
            ...
            <tr>
            <td class="td_180">
            	<label>Airport Pickup<input name="RES_GUEST_AIRPORT_PICKUP" type="checkbox" value="1" class="ml10 pickup_cb" /></label>
            </td>
            <td class="td_input">
            ...
            <div style="display: none;" id="airportpickup_open">
                ...
                <tr>
                <td class="td_220">
		          <label class="mr none lh">Airline</label><input type="text" name="RES_GUEST_AIRLINE" class="w145" />
                </td>
                <td>
  					<label class="mr lh">Flight number</label><input type="text" name="RES_GUEST_FLIGHT" class="w145" />
                </td>
                </tr>
                </table>
            </div>
            ...
            <td class="td_320">
                <div class="form-item-how">
               	<div><input type="radio" name="HEAR" class="hear radio" value="Repeat guest"/><label class="none">Repeat guest</label><br/></div>
               	<div><input type="radio" name="HEAR" class="hear radio" value="Recommendation" /><label class="none">Recommendation</label><br/></div>
            ...
            <td>
                <div class="form-item-how">
               	...
               	<div><input type="radio" class="hear hear_about_us radio" name="HEAR" value="Newspaper/Magazine/Radio"/><label>Newspaper/Magazine/Radio...</label><br /></div>
        ...
        <form style="display: none;" id="singleReservationForm">
       	<div id="guest_single_reservation_block">
        	...
        	<div class="column no-float">
                ...
                <div class="item-group">
                    <div class="item">
                    <label>Total Charge:</label><span id="TOTALCHARGE">$1,336</span>
                    </div><!--.item-->
                    <div class="item">
                    <label>Your Commission:</label><span id="YOURCOMMISSION">$0</span>
                    </div><!--.item-->
				</div><!--.item-group-->
        ...
        <form style="display: none;" id="guestLoginForm">
       	<div id="login_form">
            ...
            <ul class="reg_list">
            	<li>Don't have account yet? <a href="#register" id="gotoRegister">Register here</a></li>
                <li>Looking for <a target="_blank" href="http://www.excellence-resorts.com/excellence-resorts-image-gallery/high-resolution-images-excellence-resorts">Logos and Images</a></li>
            </ul>
            </div><!--#login_form-->
        </form>
