...
<fieldset>
    ...
    <div class="fieldset">
       ...
       <!-- <div class="label">Nombre Spanish</div>
        ...
        <div class="label">Descripcion Spanish</div>
    ...
    -->
        ...
        <div class="field"><input type="textarea" id="DESCR_EN" name="DESCR_EN" value="<? print isset($_DATA[0]['DESCR_EN']) ? $_DATA[0]['DESCR_EN'] : "" ?>"></div>       
    </div>
</fieldset>
<?//PRIORIDAD 1-10?>
        ...
        <div class="label">
            ...
            <tr>
                ...
                <td colspan="2"><div id="objWIN_TO"></div></td>
                        ...
                        <tr>
                <td colspan="2">                    
                    <input type="time" name="hourstart" id="hourstart" value="<? print isset($_DATA[0]['WIN_FROM']) ? substr($_DATA[0]['WIN_FROM'],11,8) : date("H:i:s") ?>">
                </td>
                <td></td>
                <td colspan="2">
                    <input type="time" name="hourend" id="hourend" value="<?print isset($_DATA[0]['WIN_TO']) ? substr($_DATA[0]['WIN_TO'],11,8) : date("H:i:s") ?>">
                </td>
            </tr>           
            </table>
        </div>
    </div>
                <input type="hidden" name="SYSTEM" id="SYSTEM" value="F_">
            <input type="hidden" name="ENVIRONMENT" id="ENVIRONMENT" value="Front">
            <input type="hidden" name="TYPE" id="TYPE" value="flashsale">
</fieldset>
