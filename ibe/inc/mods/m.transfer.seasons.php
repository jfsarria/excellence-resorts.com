<fieldset>
    ...
    <div class="fieldset">
        <div class="field"><input type="text" id="NAME" name="NAME" value="<? print isset($_DATA['NAME']) ? $_DATA['NAME'] : "" ?>" class="full<? if (isset($error['NAME'])) print " s_required" ?>"></div>
    </div>
</fieldset>
