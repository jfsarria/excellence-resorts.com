                ...
                <td>
                    ...
                    <span>
                        <input
                            ...
                            name="IS_ACTIVE"
                            value="1"
                            <? print (isset($_DATA[0]['IS_ACTIVE'])&&(int)$_DATA[0]['IS_ACTIVE']==1) ? "checked" : " " ;?>>
                    </span>&nbsp;&nbsp;&nbsp;
                </td>
                <td>
                    Archive&nbsp;
                    <span>
                        <input
                            ...
                            name="IS_ARCHIVE"
                            value="1"
                            <? print (isset($_DATA[0]['IS_ARCHIVE'])&&(int)$_DATA[0]['IS_ARCHIVE']==1) ? "checked" : "" ?>>
                    </span>
                </td>
            </tr>
            </table>                    
...
<fieldset>
    ...
    <div class="fieldset">
            ...
            <tr>
                ...
                <td align="right">
                    <input
                        ...
                        id="WIN_FROM"
                        name="WIN_FROM"
                        value="<? print isset($_DATA[0]['WIN_FROM']) ? $_DATA[0]['WIN_FROM'] : "" ?>" />
                </td>
                ...
                <td align="right">
                    <input
                        ...
                        id="WIN_TO"
                        name="WIN_TO"
                        value="<? print isset($_DATA[0]['WIN_TO']) ? $_DATA[0]['WIN_TO'] : "" ?>" />
                </td>
            </tr>
            <tr>
        ...
        <input type="hidden" name="TYPE" id="TYPE" value="coupon">
         <input type="hidden" name="SYSTEM" id="SYSTEM" value="C_">
