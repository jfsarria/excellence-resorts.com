...
$simple_message = array(
  ...
  "To" => "Juan Sarria Gmail <jaunsarria@gmail.com>",
  "HTML" => "This is the HTML message body with a <a href='http://google.com'>link</a>."
);
$group_name = 'IBE test group'; # optional but great for reporting, should not be unique per message
...
$complex_message = array(
  ...
  "To" => array(
    ...
    "Juan TSI <juan@townsquaredigital.com>"
  ),
  "CC" => array(
