<?
    $PREFIX = isset($isBilling)&&$isBilling ? "BILL-" : "";
?>
<select id="<?=$PREFIX?>US-states" name="<?=$PREFIX?>US-states" class="<?=$PREFIX?>states-list">
...
<select id="<?=$PREFIX?>CA-states" name="<?=$PREFIX?>CA-states" class="<?=$PREFIX?>states-list hide">
...
<select id="<?=$PREFIX?>MX-states" name="<?=$PREFIX?>MX-states" class="<?=$PREFIX?>states-list hide">
