<?
    //ob_start();print_r($_POST);	$_ARR = ob_get_clean(); mail("jaunsarria@gmail.com",'$_POST',$_ARR);
    ...
    $BOOK['RES_TOTAL_CHARGE'] += $TRANSFERS_COST;// NO IDEA WHO MADE THIS //FILE_PUT_CONTENTS('../../bw/t3lib/G.TXT', PRINT_R($BOOK, TRUE),FILE_APPEND);
