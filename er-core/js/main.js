...
$(document).ready(function(){
	...
	var maindata = $.getJSON('/ibe/index.php', {
		...
		GET_GEO : '1'
			...
			if(data.RES_PROP_ID == '6') {
				$('#hotel-info').addClass('ec');
				$('#hotel-info span').html('El Carmen');
			}
		...
		$('#rooms').append(''+
			'<div class="line border '+tmp_class+'" id="room'+k+'">'+
				...
				'<div class="inner">'+
					...
					'<div class="info">'+
						'<h3>Room Features</h3>'+
						'<p>â€¢ Full marble bathrooms, a jetted whirlpool bathtub, separate shower, separate water closet and double vanities equipped with hair dryer, scales, vanity mirror, VIP amenities and phone â€¢ Bathrobes & slippers â€¢ 27â€� satellite television â€¢ Service Box for Room Service â€¢ Air conditioning with in-room climate control â€¢ CD/DVD player â€¢ Direct dial telephone â€¢ Free high-speed internet data port â€¢ Radio/alarm clock with I-pod connectivity â€¢ Electronic in-room safe (lap-top size) â€¢ Coffee/tea maker â€¢ Stocked minibar with beer, juices, soft drinks, water and snacks â€¢ Iron & ironing board â€¢ Pillow menu â€¢ Turndown service and Excellence stationary</p>'+
					'</div>'+
...
function sidebar () {
	...
	if(data.RES_PROP_ID == '6') {
		$('.hotel-name').addClass('ec');
		$('.hotel-name span').html('El Carmen');
	}
